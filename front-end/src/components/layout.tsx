...
const getSectionHeight = (bays : Bay[]) => {
  return Math.max(...bays.map(getBayHeight).filter((width) : width is number => width !== undefined)) + SECTION_TOP_PADDING;
};
