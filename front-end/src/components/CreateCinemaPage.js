...
const CreateCinemaPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    cinemaObj.append("operator", formData.operator);
    cinemaObj.append("capacity", formData.capacity);
    ...
    console.log("Form Data:", cinemaObj);
  };
      ...
      <form className="user-info-form" onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          >
            ...
            <option value="Pavilion Bukit Bintang">
        ...
        <div className="mb-4">
          <label className="font-bold" htmlFor="operator">
            Operator
          </label>
          <select
            id="operator"
        ...
        <div className="mb-4">
          ...
          {formData.halls.map((hall, hallIndex) => (
            <div key={hallIndex} className="hall-group">
              ...
              <button
                type="button"
                className="mt-3 bg-yellow-600 text-white py-2 px-4 text-center font-medium rounded-md hover:bg-blue-700"
                onClick={() => addBay(hallIndex)}
              >
                Add Bay
              </button>
            </div>
          ...
          <button
            type="button"
            className="mt-3 bg-blue-600 text-white py-2 px-4 text-center font-medium rounded-md hover:bg-blue-700"
            onClick={addHall}
          >
            Add Hall
          </button>
        ...
        <button
          type="submit"
          className="bg-green-600 text-white py-3 px-6 text-center font-medium rounded-md hover:bg-green-700 submit-button"
        >
          Submit
        </button>
      </form>
